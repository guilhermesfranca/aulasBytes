...
export default function ComponenteComState() {
  ...
  return (
    <div className="w-1/2 bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4">
      ...
      <div className="mt-4">
        ...
        <button onClick={() => setContador(contador > 0 ? contador - 1 : 0 )} className="bg-blue-500 text-white px-2 py-1 rounded">
          -
        </button>
      </div>
      ...
      <div className="mt-4">
        ...
        <strong className=''>Strogon</strong><button onClick={() => setStrogonoff(!strogonoff)} className="bg-blue-500 text-white px-2 py-1 rounded mb-2">
          {strogonoff ? "On" : "Off"}
        </button>
      </div>
    </div>
